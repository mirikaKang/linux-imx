...
static unsigned int g_hs_settle=26;
static unsigned int g_clk_settle=0;
static unsigned int g_clk_unalive=0;
static unsigned int g_clk_swap=0;
static unsigned int g_data_swap=0;
module_param(debug, int, 0644);
module_param(g_dphy_slave_control_high,uint, 0644);
module_param(g_dphy_slave_control_low,uint, 0644);
module_param(g_hs_settle,uint,0644);
module_param(g_clk_settle,uint,0644);
module_param(g_clk_unalive,uint,0644);
module_param(g_clk_swap,uint,0644);
module_param(g_data_swap,uint,0644);
MODULE_PARM_DESC(debug, "Debug level (0-2)");
MODULE_PARM_DESC(g_dphy_slave_control_high, "mipi phy slave control register high ");
MODULE_PARM_DESC(g_dphy_slave_control_low, "mipi phy slave control register low ");
MODULE_PARM_DESC(g_hs_settle, "mipi phy Slave Clock Lane Control for T hs-settle");
MODULE_PARM_DESC(g_clk_settle, "mipi phy clk sattle b0x - 110ns to 280ns(v0.87 to v1.00 ), b10 150ns to 430ns(v0.83 to v0.86), b11 60ns to 140ns(v0.82) ");
MODULE_PARM_DESC(g_clk_unalive, "mipi phy clk 0: continuous , 1:noncontinuous");
MODULE_PARM_DESC(g_clk_swap, "mipi phy clk line swapping ctrl  0: default , 1:swap");
MODULE_PARM_DESC(g_data_swap, "mipi phy data line swapping ctrl 0: default , 1:swap");
